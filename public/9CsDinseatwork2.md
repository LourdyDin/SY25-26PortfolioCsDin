...
I would use fixed for the header so that the event name and date are always visible. Sticky for the navigation bar so that you can move between schedule and venue easily. Absolute for a notice box to highlight “Registration closes soon!” over the content. Relative for images and captions so that they stay aligned neatly with the text.